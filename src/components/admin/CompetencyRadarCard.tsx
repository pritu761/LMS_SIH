    ...
    <div className="space-y-6">
        ...
        <button
          ...
          className={`flex items-center gap-2 px-4 py-2.5 rounded-xl text-xs font-bold transition-all whitespace-nowrap ${
            activeTab === 'ALLOCATION'
              ...
              : 'text-slate-500 dark:text-slate-400 hover:text-slate-900 dark:text-white hover:bg-slate-100 dark:bg-slate-800/60'
          }`}
        >
      ...
      {activeTab === 'ALLOCATION' && (
        <div className="space-y-8 animate-fade-in-up">
          ...
          <div className="rounded-3xl border border-indigo-500/30 bg-gradient-to-br from-indigo-50 dark:from-indigo-950/50 via-white dark:via-slate-900/80 to-white dark:to-slate-950 p-6 sm:p-8 backdrop-blur-2xl shadow-2xl space-y-6 relative overflow-hidden">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 relative z-10">
              ...
              <div className="space-y-1.5 shrink-0">
                ...
                <select
                  ...
                  className="rounded-2xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-950 px-4 py-2.5 text-xs font-bold text-slate-900 dark:text-white focus:border-indigo-500 focus:outline-none focus:ring-1 focus:ring-indigo-500 shadow-xl"
                >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 pt-3 border-t border-slate-200 dark:border-slate-800/80">
              <div className="rounded-2xl bg-white dark:bg-slate-950/70 border border-indigo-500/20 p-4 space-y-1.5 transition-all hover:border-indigo-500/40">
              ...
              <div className="rounded-2xl bg-white dark:bg-slate-950/70 border border-amber-500/20 p-4 space-y-1.5 transition-all hover:border-amber-500/40">
                <div className="flex items-center justify-between">
              ...
              <div className="rounded-2xl bg-white dark:bg-slate-950/70 border border-cyan-500/20 p-4 space-y-1.5 transition-all hover:border-cyan-500/40">
                <div className="flex items-center justify-between">
              ...
              <div className="grid grid-cols-1 gap-4">
                {matchData?.matches.map((res) => {
                  ...
                  return (
                    <div
                      key={res.trainerId}
                      className="rounded-3xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900/60 p-6 backdrop-blur-xl hover:border-indigo-500/40 transition-all duration-300 space-y-4"
                    >
                      {/* Top Info Bar */}
                      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                        <div className="flex items-center gap-3.5">
                          <div className="relative">
                            ...
                            />
                            <span className="absolute -top-1.5 -left-1.5 h-6 w-6 rounded-full bg-white dark:bg-slate-950 border border-slate-200 dark:border-slate-700 text-[10px] font-black text-slate-900 dark:text-white flex items-center justify-center font-mono">
                              #{res.rank}
                            </span>
                          </div>
                          ...
                          <div>
                            ...
                            <p className="text-[11px] text-slate-500 dark:text-slate-400">{res.headline}</p>
                            <p className="text-[10px] text-indigo-400 font-mono mt-0.5">{res.organization}</p>
                          </div>
                        </div>

                        {/* Overall Score Circle/Box */}
                        <div className="flex items-center gap-4 self-end sm:self-auto bg-white dark:bg-slate-950/80 px-4 py-2.5 rounded-2xl border border-slate-200 dark:border-slate-800">
                          ...
                          <div className="text-left text-[10px] space-y-0.5 text-slate-500 dark:text-slate-400 font-mono">
                      ...
                      <div className="rounded-2xl bg-white dark:bg-slate-950/60 border border-slate-200 dark:border-slate-800/80 p-4 space-y-2">
