...
export function CoursePlayer({ course, initialEnrollment }: CoursePlayerProps) {
  ...
  return (
    <div className="space-y-6 animate-fade-in-up">
      ...
      <div className="rounded-2xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900/60 p-6 backdrop-blur-xl relative overflow-hidden">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div>
            ...
            <p className="text-xs text-slate-500 dark:text-slate-400 mt-1">
              Delivered by <span className="text-slate-900 dark:text-slate-200 font-semibold">{course.trainerName}</span> • Senior Faculty
            </p>
          </div>
        ...
        <div className="lg:col-span-2 space-y-4">
          {activeMaterial.type === 'VIDEO' ? (
            ...
            <div className="rounded-2xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900/80 overflow-hidden shadow-2xl space-y-0">
              ...
              <div className="p-5 bg-slate-50 dark:bg-slate-950/95 border-b border-slate-200 dark:border-slate-800 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <h3 className="text-sm font-bold text-slate-900 dark:text-white mt-1">{activeMaterial.title}</h3>
                  </div>
                </div>
              ...
              <div className="relative w-full min-h-[480px] sm:h-[540px] bg-white dark:bg-slate-950">
                <object
                  data={activeMaterial.url}
                  type="application/pdf"
                  className="w-full h-full min-h-[480px] sm:min-h-[540px] border-0 rounded-b-2xl bg-white dark:bg-slate-900"
                >
                  ...
                  <div className="p-8 h-full flex flex-col items-center justify-center text-center space-y-4 bg-gradient-to-b from-slate-50 dark:from-slate-900 to-white dark:to-slate-950">
                    ...
                    <div className="max-w-md space-y-1">
                      <h4 className="text-base font-bold text-slate-900 dark:text-white">{activeMaterial.title}</h4>
          ...
          <div className="rounded-2xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900/40 p-6 space-y-4 shadow-sm dark:shadow-none">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-2">
              ...
              <div className="rounded-xl bg-slate-50 dark:bg-slate-950/60 border border-slate-200 dark:border-slate-800/80 p-3 space-y-1 shadow-sm dark:shadow-none">
                ...
                <div className="text-xs text-slate-600 dark:text-slate-300 space-y-1 mt-1">
