...
export const initialCourses: MockCourse[] = [
  {
    ...
    materials: [
      ...
      },
      {
        ...
        description: 'Technical slide deck detailing 2D spatial domain splitting, boundary halo exchanges, and NetCDF4 parallel I/O on 10,000+ CPU cores.',
        type: 'PDF',
      ...
      },
      {
        ...
        description: 'Mathematical formulation of cost function minimization, background error covariance matrices, and radiance bias correction.',
        type: 'VIDEO',
      ...
      {
        id: 'mat-nwp-4',
        title: 'Mission Mausam HPC Optimization Manual (Technical Reference)',
    ...
    materials: [
      {
        ...
        description: 'Dissecting ZDR columns, correlation coefficient (CC) drops for hail detection, and differential propagation phase.',
        type: 'VIDEO',
      ...
      {
        id: 'mat-radar-2',
        title: 'IMD Doppler Radar Operation & Nyquist Velocity Guide (PDF)',
        description: 'Practical handbook on pulse repetition frequency (PRF) selection, Doppler dilemma, and de-aliasing algorithms.',
        type: 'PDF',
        url: 'https://www.w3.org/WAI/ER/tests/xhtml/testfiles/resources/pdf/dummy.pdf',
        downloadUrl: 'https://www.w3.org/WAI/ER/tests/xhtml/testfiles/resources/pdf/dummy.pdf',
        fileSize: '15.6 MB',
  ...
  },
  {
    ...
    materials: [
      {
        id: 'mat-ai-1',
        title: 'Module 1: Physics-Informed Neural Networks in Atmospheric Nowcasting',
        description: 'Constraining deep neural networks with Navier-Stokes continuity equations and moisture advection.',
        type: 'VIDEO',
      ...
      {
        id: 'mat-ai-2',
        title: 'Atmospheric AI Model Benchmark & Verification Metric Handbook',
  ...
  },
  {
    ...
    materials: [
      {
        id: 'mat-imtc-1',
        title: 'Module 1: Synoptic Weather Chart Analysis & Frontal Boundaries',
        description: 'Plotting isobars, pressure tendency symbols, and identifying monsoon troughs.',
        type: 'VIDEO',
