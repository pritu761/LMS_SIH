    ...
    <div className="flex-1 flex max-w-7xl mx-auto w-full px-4 sm:px-6 lg:px-8 py-6 gap-6">
      ...
      <main className="flex-1 min-w-0">
        {!hasStarted ? (
          ...
          <div className="rounded-3xl border border-slate-800 bg-slate-900/70 p-6 sm:p-10 backdrop-blur-xl shadow-2xl space-y-6 max-w-3xl mx-auto">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
              <div className="rounded-2xl bg-slate-950/60 border border-slate-800 p-4 text-center">
              ...
              <div className="rounded-2xl bg-slate-950/60 border border-slate-800 p-4 text-center col-span-2 sm:col-span-1">
                <span className="text-[10px] font-bold uppercase tracking-wider text-slate-400">
                  Passing Score
                </span>
            ...
            <div className="rounded-2xl bg-slate-950/40 border border-slate-800 p-4 space-y-2 text-xs text-slate-300">
