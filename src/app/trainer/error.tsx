...
/** Error boundary for the trainer area. No internals exposed. */
export default function TrainerHubError({ error, reset }: { error: Error & { digest?: string }; reset: () => void }) {
  return (
    <div className="mx-auto flex w-full max-w-2xl flex-col items-center gap-4 px-4 py-20 text-center">
      ...
      <h1 className="font-display text-2xl font-black text-[#0b1e36] dark:text-white">Faculty Hub hit a snag</h1>
      <p className="text-sm leading-relaxed text-slate-500 dark:text-slate-400">
        We could not load your faculty data just now. Please try again.
