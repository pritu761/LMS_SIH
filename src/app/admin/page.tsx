    ...
    <div className="flex-1 flex max-w-7xl mx-auto w-full px-4 sm:px-6 lg:px-8 py-6 gap-6">
      ...
      <main className="flex-1 min-w-0 space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <Link
            href="/admin/users"
            className="rounded-3xl border border-amber-500/30 bg-gradient-to-br from-amber-950/20 via-slate-900/80 to-slate-950 p-6 backdrop-blur-xl hover:border-amber-500/60 transition-all group space-y-3"
          >
          ...
          <Link
            ...
            className="rounded-3xl border border-indigo-500/30 bg-gradient-to-br from-indigo-950/20 via-slate-900/80 to-slate-950 p-6 backdrop-blur-xl hover:border-indigo-500/60 transition-all group space-y-3"
          >
            <div className="flex items-center justify-between">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="rounded-3xl border border-slate-800 bg-slate-900/60 p-6 backdrop-blur-xl space-y-4">
            ...
            {publishedSuccess && (
              <div className="rounded-2xl bg-emerald-500/10 border border-emerald-500/30 p-3 text-xs text-emerald-300 flex items-center gap-2">
            ...
            <form onSubmit={handlePublishAnnouncement} className="space-y-4">
              ...
              <div className="flex justify-end">
                <button
                  type="submit"
                  className="flex items-center gap-2 rounded-xl bg-gradient-to-r from-indigo-600 to-indigo-500 hover:from-indigo-500 hover:to-indigo-400 px-6 py-2.5 text-xs font-bold text-white shadow-lg shadow-indigo-600/30 transition-all"
                >
