      ...
      <main className="flex-1 min-w-0 space-y-6">
          ...
          <div className="relative z-10 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            <div>
              <div className="flex items-center gap-2 mb-1">
                ...
                <span className="text-xs text-slate-400">National Broadcast Control</span>
              </div>
        ...
        <MotionSection variant="fade-up" delay={100}>
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
            <div className="rounded-2xl border border-slate-800 bg-slate-900/60 p-4.5 space-y-1 card-tilt">
              ...
              <div className="text-2xl font-black text-white">{announcements.length} Active</div>
            </div>
        ...
        <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-3 animate-fade-in-up animation-delay-150">
          <div className="relative flex-1 group">
            ...
            <input
              ...
              className="w-full rounded-2xl border border-slate-700/80 bg-slate-900/80 pl-10 pr-4 py-2.5 text-xs text-slate-200 placeholder-slate-500 input-glow transition-all"
            />
          </div>
        ...
        <div className="space-y-3 stagger-children">
          {filteredAnnouncements.length > 0 ? (
                ...
                >
                  <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-[10px] text-slate-400 font-mono bg-slate-800/60 px-2 py-0.5 rounded-lg border border-slate-700/50">
                    ...
                    <div className="flex items-center gap-1.5 self-end sm:self-auto">
                      ...
                      <button
                        ...
                        className="p-1.5 rounded-xl border border-slate-700 bg-slate-800/80 text-slate-400 hover:text-white hover:bg-slate-700 transition-colors"
                        title="Edit bulletin"
                      >
                      ...
                      <button
                        ...
                        className="p-1.5 rounded-xl border border-slate-700 bg-slate-800/80 text-slate-400 hover:text-rose-400 hover:bg-rose-500/10 hover:border-rose-500/30 transition-colors"
                  ...
                  <h3 className="text-sm sm:text-base font-bold text-white">{ann.title}</h3>
            ...
            <div className="rounded-3xl border border-slate-800 bg-slate-900/40 p-12 text-center space-y-3">
              ...
              <h3 className="text-base font-bold text-white">No bulletins found</h3>
        ...
        {isComposerOpen && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-md animate-fade-in-up">
            <div className="w-full max-w-2xl rounded-3xl border border-slate-700 bg-slate-900/98 p-6 sm:p-8 shadow-2xl backdrop-blur-2xl space-y-5 animate-scale-in relative">
              <div className="flex items-center justify-between border-b border-slate-800 pb-3">
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    ...
                    <p className="text-[11px] text-slate-400">Instantly visible in all Trainee and Trainer feeds</p>
                  </div>
                </div>
              ...
              <form onSubmit={handleSaveAnnouncement} className="space-y-4">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  ...
                  <div className="space-y-1.5">
                    <label className="text-xs font-semibold text-slate-300">Author & Department</label>
                    <input
                      type="text"
                      required
                      value={authorName}
                ...
                <div className="flex items-center gap-2 pt-1">
                  ...
                  />
                  <label htmlFor="pin-directive" className="text-xs font-semibold text-slate-300 cursor-pointer">
