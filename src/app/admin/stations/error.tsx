...
/** Error boundary for the stations map. */
export default function StationsError({ error, reset }: { error: Error & { digest?: string }; reset: () => void }) {
  return (
    <div className="mx-auto flex w-full max-w-2xl flex-col items-center gap-4 px-4 py-20 text-center">
      ...
      <h1 className="font-display text-2xl font-black text-[#0b1e36] dark:text-white">Station map unavailable</h1>
      <p className="text-sm text-slate-500 dark:text-slate-400">
        Live readiness data could not be loaded.
