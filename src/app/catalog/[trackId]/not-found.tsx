...
/**
 * 404 for unknown /catalog/[trackId] codes (and tracks without a preview).
 */
export default function TrackNotFound() {
  return (
    <div className="mx-auto flex w-full max-w-2xl flex-col items-center gap-4 px-4 py-20 text-center">
      ...
      <h1 className="font-display text-2xl font-black text-[#0b1e36] dark:text-white">Track not found</h1>
      <p className="max-w-md text-sm leading-relaxed text-slate-500 dark:text-slate-400">
        No published training track matches this address. It may have been archived — browse the current catalog
        instead.
      </p>
      <Link
        href="/catalog"
