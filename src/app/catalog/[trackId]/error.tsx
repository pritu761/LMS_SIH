...
/**
 * Error boundary for /catalog/[trackId] and its preview page.
 */
export default function TrackDetailError({ error, reset }: { error: Error & { digest?: string }; reset: () => void }) {
  return (
    <div className="mx-auto flex w-full max-w-2xl flex-col items-center gap-4 px-4 py-20 text-center">
      ...
      <h1 className="font-display text-2xl font-black text-[#0b1e36] dark:text-white">This track could not be loaded</h1>
      <p className="text-sm leading-relaxed text-slate-500 dark:text-slate-400">
        The track outline is temporarily unavailable. Please try again or return to the catalog.
