...
export default function LoginPage() {
  ...
  return (
    <div className="flex-1 flex items-center justify-center p-4 sm:p-6 lg:p-8 relative">
      ...
      <div className="absolute bottom-20 right-1/3 w-80 h-80 bg-purple-600/8 rounded-full blur-3xl pointer-events-none" />
      ...
      <div className="w-full max-w-md space-y-6 relative z-10">
        ...
        <div className="rounded-2xl border border-indigo-500/25 bg-slate-900/50 p-4 space-y-3 backdrop-blur-md">
          ...
          <div className="grid grid-cols-3 gap-2">
            <button
              ...
              className="rounded-xl border border-cyan-500/30 bg-cyan-950/20 hover:bg-cyan-900/30 hover:border-cyan-400 py-2.5 text-[11px] font-bold text-cyan-300 transition-all hover:-translate-y-0.5"
            >
            ...
            <button
              ...
              className="rounded-xl border border-indigo-500/30 bg-indigo-950/20 hover:bg-indigo-900/30 hover:border-indigo-400 py-2.5 text-[11px] font-bold text-indigo-300 transition-all hover:-translate-y-0.5"
            >
            ...
            <button
              ...
              className="rounded-xl border border-emerald-500/30 bg-emerald-950/20 hover:bg-emerald-900/30 hover:border-emerald-400 py-2.5 text-[11px] font-bold text-emerald-300 transition-all hover:-translate-y-0.5"
            >
        ...
        <div className="rounded-3xl border border-slate-800 bg-slate-900/70 p-6 sm:p-8 backdrop-blur-2xl shadow-2xl space-y-5">
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full flex items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-indigo-600 to-indigo-500 hover:from-indigo-500 hover:to-indigo-400 py-3 text-sm font-bold text-white shadow-lg shadow-indigo-600/30 transition-all disabled:opacity-50 hover:scale-[1.02] active:scale-[0.98]"
            >
              {loading ? (
