    ...
    <div className="flex-1 flex items-center justify-center p-4 sm:p-6 lg:p-8 relative overflow-hidden">
      ...
      <div className="w-full max-w-lg space-y-6 relative z-10">
        ...
        <div className="text-center space-y-3 animate-fade-in-down">
          <div className="inline-flex h-16 w-16 items-center justify-center rounded-2xl bg-[#0b1e36] dark:bg-[#122c4d] border border-[#c59b48]/50 text-[#c59b48] shadow-xl shadow-[#0b1e36]/20 animate-glow-pulse">
        ...
        {/* Approval Notice */}
        <div className="rounded-2xl border border-amber-500/30 bg-amber-500/10 dark:bg-amber-950/20 p-3.5 flex items-start gap-2.5 backdrop-blur-md animate-fade-in-up animation-delay-100">
        ...
        <div className="rounded-3xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900/70 p-6 sm:p-8 backdrop-blur-2xl shadow-elevation-3 space-y-5 animate-scale-in animation-delay-200">
          {error && (
            <div className="rounded-xl bg-rose-500/10 border border-rose-500/25 p-3 text-xs text-rose-700 dark:text-rose-300 leading-relaxed flex items-center gap-2 animate-shake">
            ...
            <div className="grid grid-cols-2 gap-3">
              <button
                ...
                className={`flex items-center gap-3 rounded-2xl border p-4 text-left transition-all duration-500 hover:-translate-y-0.5 ${
                  role === 'TRAINEE'
                    ? 'border-cyan-500/60 bg-cyan-500/10 dark:bg-cyan-950/30 text-slate-900 dark:text-white shadow-lg shadow-cyan-500/10 ring-1 ring-cyan-500/30'
              ...
              >
                <div className={`h-10 w-10 rounded-xl flex items-center justify-center transition-all duration-300 ${
                  ...
                  <Award className={`h-5 w-5 transition-colors duration-300 ${role === 'TRAINEE' ? 'text-cyan-600 dark:text-cyan-400' : 'text-slate-500'}`} />
                </div>
                <div>
                  <div className="text-xs font-bold">Civil Service Trainee</div>
                  <div className="text-[11px] text-slate-600 dark:text-slate-400">Upskill and get certified</div>
                </div>
              </button>
              ...
              <button
                ...
                className={`flex items-center gap-3 rounded-2xl border p-4 text-left transition-all duration-500 hover:-translate-y-0.5 ${
                  role === 'TRAINER'
                    ? 'border-indigo-500/60 bg-indigo-500/10 dark:bg-indigo-950/30 text-slate-900 dark:text-white shadow-lg shadow-indigo-500/10 ring-1 ring-indigo-500/30'
                    : 'border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-950/40 text-slate-500 dark:text-slate-400 hover:border-slate-200 dark:border-slate-700'
                }`}
              >
                <div className={`h-10 w-10 rounded-xl flex items-center justify-center transition-all duration-300 ${
                  ...
                  <BookOpen className={`h-5 w-5 transition-colors duration-300 ${role === 'TRAINER' ? 'text-indigo-600 dark:text-indigo-400' : 'text-slate-500'}`} />
                </div>
                <div>
                  <div className="text-xs font-bold">Accredited Trainer</div>
                  <div className="text-[11px] text-slate-600 dark:text-slate-400">Teach and mentor cohorts</div>
                </div>
              </button>
            </div>
          </div>
          ...
          <form onSubmit={handleRegister} className="space-y-4">
            ...
            <div className="space-y-1.5">
              ...
              {password.length > 0 && (
                <div className="flex items-center gap-2 pt-1 animate-fade-in-up">
                  ...
                  <span className={`text-[11px] font-bold transition-colors duration-300 tabular-nums ${
                    passwordStrength === 3 ? 'text-emerald-600 dark:text-emerald-400' : passwordStrength === 2 ? 'text-amber-600 dark:text-amber-400' : 'text-rose-600 dark:text-rose-400'
                  }`}>
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full flex items-center justify-center gap-2 rounded-xl bg-[#0b1e36] hover:bg-[#122c4d] dark:bg-[#c59b48] dark:hover:bg-[#d6af5d] border border-[#c59b48]/60 dark:border-[#c59b48] py-3 text-sm font-bold text-white dark:text-[#0b1e36] gold-ink-dark shadow-lg shadow-[#0b1e36]/20 transition-all disabled:opacity-50 mt-2 hover:scale-[1.02] active:scale-[0.98] hover:shadow-glow-md btn-shimmer"
            >
              {loading ? (
          ...
          <div className="pt-4 border-t border-slate-200 dark:border-slate-800 text-center text-xs text-slate-500 dark:text-slate-400">
            ...
            <Link href="/auth/login" className="font-bold text-indigo-700 hover:text-indigo-600 dark:text-indigo-400 dark:hover:text-indigo-300 transition-colors">
              Sign In
            </Link>
          </div>
        </div>
